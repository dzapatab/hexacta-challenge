...
public class InAboutUs implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(waitTheElement(CLOSE_IMAGE).expectedState(IS_PRESENT.getValue()));
        actor.attemptsTo(Click.on(CLOSE_IMAGE));
        actor.attemptsTo(HeaderOption.selectHeaderOption(COMPANY.getValue())
                .andSelectOptionInTheHeader(ABOUT_US.getValue()));
    }
